...
export class API {
  ...
  private setupRoutes(): void {
    ...
    this.app.post('/api/tweets/create', authenticateToken, this.tweetController.createTweet.bind(this.tweetController));
    ...
    this.app.delete('/api/likes/unlike', this.likeController.unlikeTweet.bind(this.likeController));
