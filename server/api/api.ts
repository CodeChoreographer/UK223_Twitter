...
export class API {
  ...
  private setupRoutes(): void {
    ...
    this.app.post('/api/comments/add', requireAuth, requireRole('user', 'moderator', 'admin'), this.commentController.addComment.bind(this.commentController));
    this.app.delete('/api/comments/delete/:id', requireAuth, requireRole('user','moderator', 'admin'), this.commentController.deleteComment.bind(this.commentController));
